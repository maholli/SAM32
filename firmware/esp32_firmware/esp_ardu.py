...
esptool.flash_file('/sd/boot_app0.bin',               offset=0xe000)
esptool.flash_file('/sd/bootloader_qio_80m.bin',       offset=0x1000)
esptool.flash_file('/sd/GetChipID.ino.bin',            offset=0x10000)
esptool.flash_file('/sd/GetChipID.ino.partitions.bin', offset=0x8000)
